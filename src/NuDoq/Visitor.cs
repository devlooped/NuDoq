...
namespace NuDoq
{
    ...
    public abstract class Visitor
    {
        ...
        /// <see cref="Assembly"/> as input for 
        /// the <see cref="DocReader"/> so that this augmentation is 
        /// available.
        /// </remarks>
        public virtual void VisitInterface(Interface type) => VisitType(type);
        ...
        /// available.
        /// </remarks>
        public virtual void VisitClass(Class type) => VisitType(type);
        ...
        /// available.
        /// </remarks>
        public virtual void VisitStruct(Struct type) => VisitType(type);
        ...
        /// available.
        /// </remarks>
        public virtual void VisitEnum(Enum type) => VisitType(type);

        /// <summary>
        /// Visits a documented field member.
        /// </summary>
        public virtual void VisitField(Field field) => VisitMember(field);

        /// <summary>
        /// Visits a documented property member.
        /// </summary>
        public virtual void VisitProperty(Property property) => VisitMember(property);

        /// <summary>
        /// Visits a documented event member.
        /// </summary>
        public virtual void VisitEvent(Event @event) => VisitMember(@event);
        ...
        /// <see cref="ExtensionMethod"/> if an <see cref="Assembly"/> 
        /// is used with the <see cref="DocReader"/>.
        /// </remarks>
        public virtual void VisitMethod(Method method) => VisitMember(method);
        ...
        /// available.
        /// </remarks>
        public virtual void VisitExtensionMethod(ExtensionMethod method) => VisitMethod(method);
        ...
        /// types.
        /// </remarks>
        public virtual void VisitMember(Member member) => VisitContainer(member);

        /// <summary>
        /// Visits the <c>summary</c> documentation element.
        /// </summary>
        public virtual void VisitSummary(Summary summary) => VisitContainer(summary);

        /// <summary>
        /// Visits the <c>remarks</c> documentation element.
        /// </summary>
        public virtual void VisitRemarks(Remarks remarks) => VisitContainer(remarks);
        ...
        /// </summary>
        public virtual void VisitCode(Code code) => VisitElement(code);

        /// <summary>
        /// Visits the <c>c</c> documentation element.
        /// </summary>
        public virtual void VisitC(C code) => VisitElement(code);

        /// <summary>
        /// Visits the literal text inside other documentation elements.
        /// </summary>
        public virtual void VisitText(Text text) => VisitElement(text);

        /// <summary>
        /// Visits the <c>example</c> documentation element.
        /// </summary>
        public virtual void VisitExample(Example example) => VisitContainer(example);

        /// <summary>
        /// Visits the <c>see</c> documentation element.
        /// </summary>
        public virtual void VisitSee(See see) => VisitElement(see);

        /// <summary>
        /// Visits the <c>seealso</c> documentation element.
        /// </summary>
        public virtual void VisitSeeAlso(SeeAlso seeAlso) => VisitElement(seeAlso);

        /// <summary>
        /// Visits the <c>param</c> documentation element.
        /// </summary>
        public virtual void VisitParam(Param param) => VisitContainer(param);
        ...
        /// </summary>
        public virtual void VisitTypeParamRef(TypeParamRef typeParamRef) => VisitElement(typeParamRef);

        /// <summary>
        /// Visits the <c>value</c> documentation element.
        /// </summary>
        public virtual void VisitValue(Value value) => VisitContainer(value);

        /// <summary>
        /// Visits the <c>list</c> documentation element.
        /// </summary>
        public virtual void VisitList(List list) => VisitContainer(list);

        /// <summary>
        /// Visits the <c>listheader</c> documentation element.
        /// </summary>
        public virtual void VisitListHeader(ListHeader header) => VisitContainer(header);

        /// <summary>
        /// Visits the <c>term</c> documentation element.
        /// </summary>
        public virtual void VisitTerm(Term term) => VisitContainer(term);

        /// <summary>
        /// Visits the <c>description</c> documentation element.
        /// </summary>
        public virtual void VisitDescription(Description description) => VisitContainer(description);

        /// <summary>
        /// Visits the <c>item</c> documentation element.
        /// </summary>
        public virtual void VisitItem(Item item) => VisitContainer(item);

        /// <summary>
        /// Visits the <c>exception</c> documentation element.
        /// </summary>
        public virtual void VisitException(Exception exception) => VisitContainer(exception);

        /// <summary>
        /// Visits the <c>returns</c> documentation element.
        /// </summary>
        public virtual void VisitReturns(Returns returns) => VisitContainer(returns);

        /// <summary>
        /// Visits an unknown member element.
        /// </summary>
        public virtual void VisitUnknownMember(UnknownMember member) => VisitContainer(member);
